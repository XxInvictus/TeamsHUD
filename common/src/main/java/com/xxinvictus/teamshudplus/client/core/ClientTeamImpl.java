...
import com.xxinvictus.teamshudplus.client.ui.menu.TeamsScreen;
...
class ClientTeamImpl implements ClientTeam {
    ...
    public void updatePlayer(UUID player, float health, int hunger) {
        ...
        if (teammate != null) {
            ...
            TeamsHUDPlus.LOGGER.warn("Tried updating player with UUID {} but they are not in this client's team", player);
        }
    }
