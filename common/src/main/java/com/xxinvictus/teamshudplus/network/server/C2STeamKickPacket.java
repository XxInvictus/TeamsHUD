    ...
    public void handleServer(ServerPlayer player) {
        ...
        if (player != null && team.playerHasPermissions(player)) {
            ...
            try {
                ...
                TeamsHUDPlus.LOGGER.error("Failed to kick player {} from team '{}': {}", toKick, name, ex.getMessage(), ex);
            }
        } else {
            TeamsHUDPlus.LOGGER.error("Player {} attempted to kick {} from team '{}' without permissions", 
